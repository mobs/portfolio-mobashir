    ...
    return (
        <Card className={classes.projectItem}>
            ...
            <div className={classes.controls}>
                ...
                <p className={classes.techUsed} style={{color:nonThemeColor}}>TECH: {props.project.techStack}</p>
                <a target="_blank" rel="noreferrer" href={props.project.demoLink} style={{color:nonThemeColor}}> <LinkIcon fontSize="large"/></a>
            </div>
        </Card>
    )
};
